...
void admin::updateBooksDetails()
{
    ...
    if (count == 0)
    {
        ...
        cout << setw(60) << "********Update Successfull.********" << endl;
    file.close();
    file1.close();
...
void admin::deleteBooks()
{
    ...
    if (count == 0)
    {
        ...
        cout << setw(60) << "********Deletion Successfull.********" << endl;
    file.close();
    file1.close();
    remove("BooksRecord.txt");
    rename("tempFile.txt", "BooksRecord.txt");
...
void customer::buyBooks()
{
    ...
    system("cls");
    cout << setw(72) << "*******************************************" << endl;
    cout << setw(30) << "*" << setw(30) << "Buy Books Corner:" << setw(12) << "*" << endl;
    cout << setw(72) << "*******************************************" << endl
         << endl;
...
label:
    ...
    case 1:
    {
        ...
        if (count == 0)
        {
            ...
            cout<<"\nPlease enter the number of copies you want to buy:";
            cin>>number_of_copies;
            if(number_of_copies<=copies){
                float total=number_of_copies*price;
                cout<<"\n\nYour total amount is:"<<total<<endl;
                cout<<"\n\nPlease press enter to pay:";
                getch();
                cout<<"\n\nThanks for shopping with us."<<endl;
            }
            else{
                cout<<"\n Sorry we don't have "<<number_of_copies<<" copies."<<endl<<"We only have "<<copies<<" avaliable."<<endl;
            }
        }
        cout << "\n\nPress any key to exit:";
        getch();
...
void customer::customer_Services()
{
    while (1)
    {
        system("cls");
        cout << setw(72) << "*******************************************" << endl;
        cout << setw(30) << "*" << setw(35) << "Welcome to Customer Pannel" << setw(7) << "*" << endl;
        cout << setw(72) << "*******************************************" << endl
             << endl;
